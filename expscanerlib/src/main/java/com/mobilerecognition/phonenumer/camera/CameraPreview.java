...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Camera.AutoFocusCallback, PreviewCallback {
    ...
    private void doSurfaceChanged(int width, int height) {
        ...
        if (!mSurfaceConfiguring) {
            ...
            if (DEBUGGING) {
                Log.v(LOG_TAG, "determinePreviewSize - w: " + previewSize.width + ", h: " + previewSize.height);
                Log.v(LOG_TAG, "determinePictureSize - w: " + pictureSize.width + ", h: " + pictureSize.height);
...
//        }
    ...
    protected boolean adjustSurfaceLayoutSize(Size previewSize, boolean portrait, int availableWidth, int availableHeight) {
    ...
    public void onPreviewFrame(byte[] arg0, Camera arg1) {
        ...
        //ScanTestActivity act = (ScanTestActivity)mActivity;
