...
public class SoundClips {
    ...
    // Sound actions.
    public static final int PICTURE_BEGIN = 0;
    public static final int PICTURE_COMPLETE = 1;
    ...
    private static class SoundPoolPlayer implements  Player, SoundPool.OnLoadCompleteListener {
        ...
        public SoundPoolPlayer(Context context) {
            mContext = context;
            int audioType = getIntFieldIfExists(AudioManager.class,
        ...
        public void onLoadComplete(SoundPool pool, int soundID, int status) {
            ...
            if (soundID == mSoundIDToPlay && mSoundPool != null) {
                mSoundIDToPlay = ID_NOT_LOADED;
