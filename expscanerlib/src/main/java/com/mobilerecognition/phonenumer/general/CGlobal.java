package com.mobilerecognition.phonenumer.general;
...
public class CGlobal {
    public static int theDigitCount = 11;
    ...
    public static String SaveRecogImage(String szFileName, Bitmap bmImage) {
        File dir = new File(Environment.getExternalStorageDirectory().toString(), "/aPhoneNumber/PreviewImages/");
